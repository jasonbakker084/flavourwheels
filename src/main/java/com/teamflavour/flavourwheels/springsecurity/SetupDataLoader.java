...
//        createUserIfNotFound("testuser@testuser.com", "Test", "User", "test", new ArrayList<Role>(Arrays.asList(userRole)));
    ...
    private void createFlavorsWhiskeyIfNotFound(){
        ...
        addFlavorWhiskeyIfNotFound("Honey","#8C92C6",  166,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Leathery", "#8C92C6", 167,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Tobacco", "#8C92C6", 168,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Sweaty","#8C92C6",  169,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Plastic","#8C92C6",  170,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Sandy", "#B4B4B4", 171,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Rubbery","#B4B4B4",  172,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Coal-Gas","#B4B4B4",  173,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Vegitative","#B4B4B4",  174,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Toasted","#9F816A",  175,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Vanilla","#9F816A",  176,  4 );
        ...
        addFlavorWhiskeyIfNotFound("Old Wood","#9F816A",  177,  4 );
        ...
        addFlavorWhiskeyIfNotFound("New Wood","#9F816A",  178,  4 );
