...
public class CoffeeController {
    ...
    @Autowired
    public CoffeeController(CoffeeRepository coffeerepository, WineRepository winerepository, WhiskeyRepository whiskeyRepository, UserRepository userRepository, FlavorCoffeeRepository flavorCoffeeRepository) {
